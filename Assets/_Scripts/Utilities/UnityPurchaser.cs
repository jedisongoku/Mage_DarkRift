...
public class UnityPurchaser : MonoBehaviour, IStoreListener
{
    ...
    public static string consumableID;
    public static string gems30 = "com.mandalingames.mage.io.30gems";
    public static string gems80 = "com.mandalingames.mage.io.80gems";
    public static string gems170 = "com.mandalingames.mage.io.170gems";
    public static string gems360 = "com.mandalingames.mage.io.360gems";
    public static string gems950 = "com.mandalingames.mage.io.950gems";
    public static string gems2500 = "com.mandalingames.mage.io.2500gems";
    ...
    public void InitializePurchasing()
    {
        ...
        builder.AddProduct(gems30, ProductType.Consumable);
        builder.AddProduct(gems80, ProductType.Consumable);
        builder.AddProduct(gems170, ProductType.Consumable);
        builder.AddProduct(gems360, ProductType.Consumable);
        builder.AddProduct(gems950, ProductType.Consumable);
    ...
    public void BuyConsumable(int id)
    {
        switch(id)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                BuyProductID(gems170);
                break;
            case 4:
                BuyProductID(gems360);
                break;
            case 5:
                BuyProductID(gems950);
                break;
            case 6:
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        ...
        if (String.Equals(args.purchasedProduct.definition.id, gems30, StringComparison.Ordinal))
        {
